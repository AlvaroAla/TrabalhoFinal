...
if (
    isset($_POST["nome"]) && isset($_POST["dtnasc"]) && isset($_POST["cpf"]) && isset($_POST["telefone"]) &&
                ...
                <div class="col-lg-6 col-md-12 col-xs-12"> <!--2 de 3-->
                    <form id="formCadastro" action="cadastroUsuario.php" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <div id="cpf" class="form-text">Coloque seu CPF sem pontos (.) e traços (-).</div>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="telefone" placeholder="+99 (99) 999999999" name="telefone">
                            <label for="telefone">Telefone:</label>
                            <div id="cpf" class="form-text">Coloque seu telefone sem espaços, traços (-), etc., apenas os números (prefixo, DDD e o restante)</div>
                        </div>
                        <div class="form-floating mb-3">
